...
for i in range(0, images.__len__()):
    ...
    if i == 0 or i % 3 == 0:
        mdFile = mdFile + f'\n<img src="https://github.com/MIZU-TEAM/MIZU-CARDS/blob/main/cards/{githubFileName}" width="300">'
    else:
        mdFile = mdFile + f'<img src="https://github.com/MIZU-TEAM/MIZU-CARDS/blob/main/cards/{githubFileName}" width="300">'
